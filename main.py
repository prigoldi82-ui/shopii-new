...
CHECKER_API_URL = 'https://api-shopi-production.up.railway.app/shopify'
...
async def check_card(card, site, proxy):
    ...
    try:
        ...
        price = raw.get('Price', '-')
        gate = raw.get('Gate', 'Shopify Payment')
...
🚨 <b>{result['message'].upper()}</b>

💳 CC: <tg-spoiler>{result['card']}</tg-spoiler>
💵 <b>Gate:</b> {result.get('gateway','Unknown')}
...
👤 Bot by:
<a href="tg://user?id=8348667414">K E S A V</a>
"""
...
<b>☑️ SHOPIFY</b>
━━━━━━━━━━━━━━━━━
💳 <b>CC ➜</b> <tg-spoiler>{result['card']}</tg-spoiler>

{status_emoji} <b>Status ➜</b> <b>{status_text}</b>
📊 <b>Response ➜</b> <code>{result['message']}</code>
<blockquote>💰 <b>Price ➜</b> ${result.get('price', '-')}
💵 <b>Gate ➜</b> {result.get('gateway', 'Unknown')}

🏦 <b>BIN ➜</b> {brand} - {bin_type}
📈 <b>Level ➜</b> {level}
🏛️ <b>Bank ➜</b> {bank}
🌍 <b>Country ➜</b> {flag} {country}
</blockquote>
━━━━━━━━━━━━━━━━━
👤 <b>Bot by ➜</b> <a href="tg://user?id=8348667414"><b>K E S A V</b></a>
"""
